...
function checkWinner() { //looks like chicken dinner s fts
    ...
    for (let c = 0; c < 3; c++) {
        if (board[0][c] == board[1][c] && board[1][c] ==  board[2][c] && board[0][c] != ' ') {
            ...
            gameOver = true;
            return; //san serif 1'34 idk what this is so i icant't really know point of cprrectob 
            //the function return is very different from the official laptop so idk what to do now 
        }
    }
